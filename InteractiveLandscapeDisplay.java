 ...
 * Author: Hannah Soria
 * Date: 5/2/2022
 * File: InteractiveLandscpaeDisplay.java
...
public class InteractiveLandscapeDisplay {
    ...
    public InteractiveLandscapeDisplay() {
        ...
        Vertex v1 = new Vertex( 0, 0 , false);
        v1.setVisible( true );
        v1.setCost( 0 );
        Vertex v2 = new Vertex( 0, 1 ,false);
        v2.setVisible( true );
        v2.setCost( 1 );
        Vertex v3 = new Vertex( 0, 2 ,false);
        v3.setVisible( true );
        v3.setCost( 2 );
        Vertex v4 = new Vertex( 0, 3 ,false);
        v4.setVisible( true );
        v4.setCost( 3 );
